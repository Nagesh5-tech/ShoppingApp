...
@Service
public class AdminBussinessService implements AdminBussinessServiceContract{
	...
	public AdminBussinessService(OrderRepository orderRepository, OrderItemRepository orderItemRepository,
	...
	public Map<String, Object> calculateOverallBusiness() {
	    List<Order> successfulOrders = orderRepository.findAllByStatusOverallBusiness();
